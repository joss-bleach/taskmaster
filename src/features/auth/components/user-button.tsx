  ...
  if (isLoading) {
    return (
      <div className="flex size-10 items-center justify-center rounded-full border border-neutral-300 bg-neutral-200">
        <Loader2Icon className="text-muted-foregorund size-4 animate-spin" />
      </div>
    );
  }
  ...
  return (
    <DropdownMenu modal={false}>
      ...
      >
        ...
        <DropdownMenuItem
          onClick={() => mutate()}
          className="flex h-10 cursor-pointer items-center justify-center font-medium text-amber-700 hover:text-amber-700"
        >
